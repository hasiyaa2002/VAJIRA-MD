...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=XIdkgbDI#zNecyZfylLj7iOtc_XdvuB3Kdank_1NXsQV_G-NWqBE' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94763118285,94754625969" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '500': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'ꪖꪶᠻꪖ' ,
COMMAND_TYPE: process.env.COMMAND_TYPE || 'button' ,
LOGO: process.env.LOGO || `https://telegra.ph/file/ab0ea6ad90e2eb98090d9.jpg` ,
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgres://vajiratech_user:oSIFl2xmSojMZ0rkzdd0g0W6msuVTpNN@dpg-cpd7fjv109ks73e5gtig-a.frankfurt-postgres.render.com/vajiratech' : process.env.POSTGRESQL_URL,
FOOTER: process.env.FOOTER || '‌𓄂ʙʟᴀᴄᴋ ᴀʟꜰᴀ࿐ ᴍᴅ',    
